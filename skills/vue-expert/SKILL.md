---
name: vue-expert
description: Use when building Vue 3 applications with Composition API or Nuxt 3. Invoke for Pinia, TypeScript and Vite configuration.
license: MIT
metadata:
  author: https://github.com/Jeffallan
  version: "1.0.0"
  domain: frontend
  triggers: Vue 3, Composition API, Nuxt, Pinia, Vue composables, reactive, ref, Vue Router, Vite Vue, Fastify SSR, sourcemap, Vite config, build optimization
  role: specialist
...
- Use Pinia or vue query for global state management
...
Vue 3 Composition API, Pinia, Nuxt 4, Vue Router (latest), Vite, VueUse, TypeScript, Vitest, Vue Test Utils, SSR/SSG, reactive programming, performance optimization
